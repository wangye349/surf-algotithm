...
%%
tic
[r,g,b] = read_img('C:\Users\wangy\Documents\MATLAB\surf\TestImages\flower.jpg');
...
% keypoint4 = compare_num27(r,27,39,51);
% keypoint5 = compare_num27(r,27,51,75);
% keypoint6 = compare_num27(r,51,75,99);
[m,n] = size(r);
r_change = r;
...
%             end
%         end
%         if(size(keypoint7,2)~=0)
%             if([i,j] == [keypoint7(1),keypoint7(2)])
%                 keypoint7(1:2) = [];
%                 r_change(i,j) = 255;
%                 r_change(i-1,j) = 0;
%                 r_change(i-1,j-1) = 255;
...
save_img('C:\Users\wangy\Documents\MATLAB\surf\TestImages\flower_change.bmp',r_change,r_change,r_change);%r_change); 
toc